...
public class ClanData {
	...
	public ClanData(UUID id, String tag, String desc, UUID leader, boolean verified, List<HomesData> home, long creationDate, ClanStats clanStats, List<UUID> members, List<UUID> onlineMembers, boolean ff, double kdr, String tagNoColor, List<UUID> mods, List<UUID> banned, ClanRivalAlly rivalAlly, int bank, int level, ClanQuestInfoData quest, SettingsData settings, ChestSettingsData chestSettings, String banner, int maxlevel, int extraSlots, String patent) {
		this.setId(id);
		this.setTag(tag);
		this.setDesc(desc);
