...
public class PlayerData {
	...
	public PlayerData(UUID id, String name, UUID uuid, UUID clan_id, int kills, int deaths, int souls, double kdr, long joinDate, long lastSeen, String cache, String nickname, String customSkin, PlayerData_Settings settings) {
		this.setId(id);
		this.setName(name);
		this.setUuid(uuid);
